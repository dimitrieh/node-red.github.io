...
export const contributors: ContributorGroup[] = [
  ...
  },
  {
    ...
    header:
      "People who are regularly contributing to the core project or who have made notable contributions in the project's history.",
    footer:
      'Explore the full list <a href="https://github.com/node-red/node-red/graphs/contributors" target="_blank">here</a>',
    people: [
      {
        name: 'Ben Hardill',
        githubId: '1800845',
