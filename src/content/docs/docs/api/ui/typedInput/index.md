...
`autoComplete` | function |   | *Since 2.1.0.* If set, enable autoComplete on the input, using this function to get completion suggestions. See [autoComplete](/docs/api/ui/autoComplete) for details. This option cannot be used with `options`, `hasValue=false` or `valueLabel`
...
<div class="nr-widget-demo"><nr-typed-input config='{"type":"str","types":["str","num","bool"]}'></nr-typed-input></div>
...
<div class="nr-widget-demo"><nr-typed-input config='{"type":"msg","types":["msg"]}'></nr-typed-input></div>
...
<div class="nr-widget-demo"><nr-typed-input config='{"type":"flow","types":["flow","global"]}'></nr-typed-input></div>
