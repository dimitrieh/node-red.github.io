...
<div class="figure">
  <img src="/docs/developing-flows/images/mqtt-query.png" alt="MQTT to database query">
...
<div class="figure">
  <img src="/docs/developing-flows/images/mqtt-query-save-id.png" alt="Using a Change node to copy the payload to msg.id">
...
<div style="width: 343px" class="figure align-right">
  <img src="/docs/developing-flows/images/debug-topic.png" alt="msg.topic shown in debug sidebar message">
