...
how to create custom modules, are available on the [api pages](/docs/api/context).
...
The [Writing Functions guide](/docs/user-guide/writing-functions#storing-data) describes
