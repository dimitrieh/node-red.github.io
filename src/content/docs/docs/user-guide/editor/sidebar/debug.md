...
<div style="width: 300px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-sidebar-debug.png" alt="Debug messages Sidebar">
...
<div style="width: 209px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-sidebar-debug-filter.png" alt="Debug filter options">
...
<div style="width: 296px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-sidebar-debug-pause.png" alt="Debug paused">
...
The debug sidebar registers the following actions that can be accessed from the [action menu](/docs/user-guide/editor/workspace/actions) or have a [keyboard shortcut](/docs/user-guide/editor/workspace/keyboard) assigned.
