...
The outline view can be searched using the same syntax as the [main search dialog](/docs/user-guide/editor/workspace/search).

Hovering over an entry in the outline reveals a set of options.

<div style="width: 344px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-sidebar-info-entry.png" alt="Outline entry options">
