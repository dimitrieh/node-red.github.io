...
<div style="width:400px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-search.png" alt="Search dialog">
  <p class="caption">Search dialog</p>
</div>
<br>
<div style="width:246px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-search-menu.png" alt="Search menu">
...
button in the header will copy the current search over to the [Explorer sidebar](/docs/user-guide/editor/sidebar/explorer) search.
...
<div style="width:235px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-search-toolbar.png" alt="Search toolbar">
