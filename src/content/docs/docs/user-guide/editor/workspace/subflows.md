...
<div class="figure">
  <img src="/docs/user-guide/editor/images/editor-subflow-create-selection.png" alt="Creating a subflow">
  <p class="caption">Creating a subflow</p>
</div>

<div style="width:400px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-subflow-invalid-selection.png" alt="Invalid subflow selection">
...
<div style="width:616px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-edit-subflow.png" alt="Editing a subflow">
...
<div class="figure">
  <img style="width: calc(50% - 10px); display: inline-block;" src="/docs/user-guide/editor/images/editor-edit-subflow-properties.png" alt="Subflow edit dialog - properties">
  <img style="width: calc(50% - 10px); margin-left: 10px; display: inline-block;"  src="/docs/user-guide/editor/images/editor-edit-subflow-module-properties.png" alt="Subflow edit dialog - module properties">
  <img style="width: calc(50% - 10px);  display: inline-block;"  src="/docs/user-guide/editor/images/editor-edit-subflow-description.png" alt="Subflow edit dialog - description">
  <img style="width: calc(50% - 10px); margin-left: 10px; display: inline-block;"  src="/docs/user-guide/editor/images/editor-edit-subflow-appearance.png" alt="Subflow edit dialog - appearance">
...
<div style="width:487px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-edit-subflow-property.png" alt="Editing subflow properties">
  <p class="caption">Editing subflow properties</p>
</div>
<div style="width:487px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-edit-subflow-property-ui.png" alt="Editing subflow property UI">
