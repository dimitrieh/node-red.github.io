...
<div style="width: 500px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-default.png" alt="Editor window">
...
It also contains a toggle button for the view navigator.
 ...
 <div style="width: 349px" class="figure">
   <img src="/docs/user-guide/editor/images/editor-workspace-navigator.png" alt="Workspace footer with view navigator active">
...
<div style="width: 450px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-user-settings-view.png" alt="User Settings View tab">
