...
<div style="width:400px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-settings-keyboard.png" alt="Keyboard settings">
  <p class="caption">Keyboard settings</p>
</div>

All of the [actions](/docs/user-guide/editor/workspace/actions) in the editor can be assigned to keyboard shortcuts. Not all of the core actions have preassigned
shortcuts.
...
<div style="width:557px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-settings-keyboard-edit.png" alt="Editing a shortcut">
  <p class="caption">Editing a shortcut</p>
</div>
