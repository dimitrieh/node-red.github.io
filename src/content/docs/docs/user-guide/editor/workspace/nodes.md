...
Nodes can be added to the workspace by either:
 ...
 - dragging them from the [palette](/docs/user-guide/editor/palette),
 ...
 <div style="width: 222px" class="figure align-right">
   <img src="/docs/user-guide/editor/images/editor-node-port-label.png" alt="Node port labels">
...
<div style="width: 550px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-node-details.png" alt="Node elements">
...
<div style="width: 208px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-node-errors.png" alt="Node error tooltip">
...
show a popup containing the documentation. This is also shown in the [Information Sidebar](/docs/user-guide/editor/sidebar/info) when
...
<div style="width: 416px" class="figure">
  <img src="/docs/user-guide/editor/images/editor-node-docs.png" alt="Node documentation">
...
<div style="width: 340px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-quick-add.png" alt="Quick-Add dialog">
...
<ul>
    ...
    <li style="margin-bottom: 10px"><i style="border-radius: 4px; display:inline-block;text-align:center; width: 30px; color: #777; border: 1px solid #777; padding: 6px;" class="fa fa-file-text"></i> : Description - per-node documentation formatted using Markdown. This is displayed in the <a href="/docs/user-guide/editor/sidebar/info">Information sidebar</a> when the node is selected.</li>
...
<div class="figure">
  <img style="width: calc(30% - 10px); display: inline-block;" src="/docs/user-guide/editor/images/editor-edit-node.png" alt="Node edit dialog - properties">
  <img style="width: calc(30% - 10px); margin-left: 10px; display: inline-block;"  src="/docs/user-guide/editor/images/editor-edit-node-description.png" alt="Node edit dialog - description">
  <img style="width: calc(30% - 10px); margin-left: 10px; display: inline-block;"  src="/docs/user-guide/editor/images/editor-edit-node-appearance.png" alt="Node edit dialog - appearance">
...
<div style="width:468px;" class="figure align-center">
  <img src="/docs/user-guide/editor/images/editor-edit-node-config-node.png" alt="Adding a configuration node">
...
<div style="width:321px;" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-edit-config-node.png" alt="Configuration node edit dialog">
