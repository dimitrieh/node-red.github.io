...
<div class="figure">
  <img src="/docs/user-guide/editor/images/editor-flow-tabs.png" alt="Flow tabs">
...
Each flow can have a name, and description that is displayed in the [Information sidebar](/docs/user-guide/editor/sidebar/info).
...
<div style="width:350px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-edit-flow.png" alt="Flow properties editor">
  <p class="caption">Flow properties editor</p>
  <img src="/docs/user-guide/editor/images/editor-sidebar-explorer.png" alt="Explorer Sidebar">
...
<ul>
    ...
    can use Markdown syntax for formatting and will appear in the <a href="/docs/user-guide/editor/sidebar/info">Information sidebar</a>.</li>
...
The <i style="font-size: 0.8em; border-radius: 4px; display:inline-block;text-align:center; width: 20px; color: #777; border: 1px solid #777; padding: 3px;" class="fa fa-circle-thin"></i> button in the [Explorer sidebar](/docs/user-guide/editor/sidebar/explorer) can also be used to enable or disable the node/flow.
...
When hidden, the [Explorer sidebar](/docs/user-guide/editor/sidebar/explorer) will show an <i style="border-radius: 2px; display:inline-block;text-align:center; width: 30px; color: #777; border: 1px solid #777; padding: 6px;" class="fa fa-eye-slash"></i> icon next to it. Clicking that icon will show the flow again.
...
<div style="width:400px" class="figure align-right">
  <img src="/docs/user-guide/editor/images/editor-flow-search-tabs.png" alt="Search flows">
