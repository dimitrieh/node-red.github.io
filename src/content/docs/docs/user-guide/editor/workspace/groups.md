...
<div style="width: 792px" class="figure align-centre">
  <img src="/docs/user-guide/editor/images/editor-group.png" alt="Groups">
...
<ul>
    ...
    <li style="margin-bottom: 10px"><i style="border-radius: 2px; display:inline-block;text-align:center; width: 30px; color: #777; border: 1px solid #777; padding: 6px;" class="fa fa-file-text"></i> : Description - per-node documentation formatted using Markdown. This is displayed in the <a href="/docs/user-guide/editor/sidebar/info">Information sidebar</a> when the group is selected.</li>
</ul>

<div class="figure">
  <img style="width: calc(50% - 10px); display: inline-block;" src="/docs/user-guide/editor/images/editor-edit-group.png" alt="Group edit dialog - properties">
  <img style="width: calc(50% - 10px); margin-left: 10px; display: inline-block;"  src="/docs/user-guide/editor/images/editor-edit-group-description.png" alt="Group edit dialog - description">
